define(['dart_sdk', 'packages/path/path'], (function load__packages__stack_trace__src__chain(dart_sdk, packages__path__path) {
  ...
  var ObjectLAndStackTraceLToNullN = () => (ObjectLAndStackTraceLToNullN = dart.constFn(dart.fnType(core.Null, [ObjectL(), StackTraceL()])))();
  ...
  trace$.Trace = class Trace extends core.Object {
    ...
    toString() {
      ...
      return this.frames[$map](StringL(), dart.fn(frame => {
        ...
        return dart.str(frame.location[$padRight](longest)) + "  " + dart.str(frame.member) + "\n";
  ...
  chain$.Chain = class Chain extends core.Object {
    ...
    toString() {
      ...
      return this.traces[$map](StringL(), dart.fn(trace => trace.frames[$map](StringL(), dart.fn(frame => dart.str(frame.location[$padRight](longest)) + "  " + dart.str(frame.member) + "\n", FrameLToStringL()))[$join](), TraceLToStringL()))[$join](utils.chainGap);
    }
  };
